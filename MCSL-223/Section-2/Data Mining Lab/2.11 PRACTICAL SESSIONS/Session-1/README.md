...
Phase 1: Create the Data in Excel
Open Microsoft Excel.
Row 1 must contain your Attribute Names (headers).
Rows 2 onwards contain your actual data (Instances).
Important Rule: Do not use spaces in your Attribute names or Text data. Use underscores (_) instead (e.g., High_School instead of High School).
Example Dataset (Student_Placement):
