...
* Student Management System Servlet JSP Example [GitHub](https://github.com/kishan0725/Student-Management-System)

* CRUD App with JSP, Servlet, JDBC [JSP Servlet JDBC MySQL Create Read Update Delete (CRUD)](https://www.codejava.net/coding/jsp-servlet-jdbc-mysql-create-read-update-delete-crud-example)<br>
[JSP Servlet JDBC MySQL CRUD](https://www.javaguides.net/2019/03/jsp-servlet-jdbc-mysql-crud-example-tutorial.html)

* Session Handling [Session Management in Java - HttpServlet, Cookies, URL Rewriting](https://www.digitalocean.com/community/tutorials/java-session-management-servlet-httpsession-url-rewriting)<br>
  [Session Management in Web Apps: Servlets, JSP, Error Handling](https://studylib.net/doc/27521054/slot-8-9-10-sessions) <br>
[Servlet - HttpSession Login and Logout](https://www.geeksforgeeks.org/java/servlet-httpsession-login-and-logout-example/)

* Error Handling in Servlet/JSP [DigitalOcean: Servlet Exception and Error Handling](https://www.digitalocean.com/community/tutorials/servlet-exception-and-error-handling-example-tutorial)
